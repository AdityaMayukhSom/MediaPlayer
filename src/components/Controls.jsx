        ...
        >
            <div className="flex flex-row items-center w-full ">
                ...
                >
                    ...
                    <div className="box-border absolute z-10 w-4 h-4 transition-all duration-200 ease-in-out scale-0 bg-white rounded-full shadow group-hover:scale-100" ref={progressSlider} id="progressSlider"></div>
                </div>
            ...
            <div className="flex flex-col items-center justify-between w-full pl-4 text-xs font-medium text-gray-500 sm:flex-row">
                ...
                <div className="flex items-center">
                    ...
                    <div className="flex flex-row items-center justify-center px-1 ">
                        ...
                        >
                            <svg className="w-10 h-10" viewBox="0 0 24 24" title="Increment Video">
                    ...
                    <div className="flex flex-row items-center mt-1 text-white group">
                        ...
                        <div className="h-1 mx-3 w-0 group-hover:w-[100px] transition-all duration-300 bg-gray-300 rounded cursor-pointer flex items-center relative" onClick={(e) => handleVolumeBarClick(e)} ref={myVolumeBar}>
                            ...
                            <div className="absolute w-3 h-3 max-w-full transition-all duration-300 ease-in-out scale-0 bg-white rounded-full shadow group-hover:scale-100" ref={volumeSlider}></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center">
                    <div className="relative flex items-center mt-1 mr-4 group">
                        ...
                        <label htmlFor="autoPlayCheckBox" className="absolute flex items-center justify-center w-5 h-5 transition-all duration-500 bg-white rounded-full cursor-pointer" style={checkButtonTransition}>
                            {isAutoPlay && (
                    ...
                    <div className="group">
                        <button className="p-1 mx-1 mt-1 transition-all duration-300 rounded focus:outline-none active:outline-none aspect-square group-hover:bg-gray-300 group-hover:bg-opacity-20 group-hover:mt-0 group-hover:mb-1">
                            <svg className="w-8 h-8" viewBox="0 0 24 24" title="Playback Speed">
                                {playbackSpeed < 1 && (
                                    <path
                                        fill="#fff"
                        ...
                        <div className=" absolute rounded-lg -right-[3rem] md:right-[8.5rem] bottom-[4.5rem] bg-opacity-95 shadow-lg text-white bg-[#262626] px-4 py-6 transition-all mb-12 group-hover:mb-0 group-hover:visible invisible opacity-0 group-hover:opacity-100 duration-700 scale-75 md:scale-100">
                            ...
                            <ol className="flex flex-row items-center justify-between " onClick={(e) => handlePlaybackSpeed(e)}>
                                <li className="relative w-[92px] h-full ">
                                    <div className="grid grid-cols-[40px_auto] items-center ml-[8px]">
                                        <div className="z-10 flex items-center justify-center w-4 mx-auto bg-gray-200 border rounded-full cursor-pointer aspect-square" data-speed="0.50" ref={speed050}></div>
                                ...
                                <li className="relative w-32 h-full ">
                                    <div className="grid grid-cols-[auto_40px_auto] items-center">
                                        <div className=" w-full bg-gray-200 h-0.5"></div>
                                        <div className="z-10 flex items-center justify-center w-4 mx-auto bg-gray-200 border rounded-full cursor-pointer aspect-square " data-speed="0.75" ref={speed075}></div>
                                        <div className=" w-full bg-gray-200 h-0.5"></div>
                                    </div>
                                ...
                                <li className="relative w-32 h-full ">
                                    <div className="grid grid-cols-[auto_40px_auto] items-center">
                                        <div className=" w-full bg-gray-200 h-0.5"></div>
                                        <div className="z-10 flex items-center justify-center w-4 mx-auto bg-gray-200 border rounded-full cursor-pointer aspect-square" data-speed="1.00" ref={speed100}></div>
                                        <div className=" w-full bg-gray-200 h-0.5"></div>
                                    </div>
                                ...
                                <li className="relative w-32 h-full ">
                                    <div className="grid grid-cols-[auto_40px_auto] items-center">
                                        <div className=" w-full bg-gray-200 h-0.5"></div>
                                        <div className="z-10 flex items-center justify-center w-4 mx-auto bg-gray-200 border rounded-full cursor-pointer aspect-square" data-speed="1.25" ref={speed125}></div>
                                        <div className=" w-full bg-gray-200 h-0.5"></div>
                                    </div>
                                ...
                                <li className="relative w-[92px] h-full ">
                                    <div className="grid grid-cols-[auto_40px] items-center mr-[8px]">
                                        <div className=" w-full bg-gray-200 h-0.5"></div>
                                        <div className="z-10 flex items-center justify-center w-4 mx-auto bg-gray-200 border rounded-full cursor-pointer aspect-square" data-speed="1.50" ref={speed150}></div>
                                    </div>
                    ...
                    <div className="mx-1" title="Setting Icon And Box">
                        <button className="p-1 mt-1 transition-all duration-300 rounded focus:outline-none active:outline-none aspect-square hover:bg-gray-300 hover:bg-opacity-20 hover:mt-0 hover:mb-1 active:scale-75" title="Settings" onClick={() => toggleSettings()}>
                            <svg className="w-8 h-8" viewBox="0 0 24 24" title="Settings">
                                    ...
                                    <li>
                                        <div className="flex w-full  px-4 py-4 hover:bg-[#434343] hover:text-white justify-between">
                                            ...
                                            <div className="relative flex items-center ">
                                                <input className="w-12 h-5 bg-gray-400 rounded-full shadow-sm appearance-none cursor-pointer checked:bg-blue-500 focus:outline-none" type="checkbox" role="switch" id="annotation" />
                    ...
                    <div className="relative flex items-center group">
                        ...
                        <button className="p-1 mx-1 mt-1 transition-all duration-300 rounded focus:outline-none active:outline-none aspect-square hover:bg-gray-300 hover:bg-opacity-20 hover:mt-0 hover:mb-1 active:scale-75" title="Loop" onClick={() => handleLoop()}>
                            <svg className="w-8 h-8" viewBox="0 0 24 24" title="Loop">
                                <path
                    ...
                    <div className="relative flex items-center ml-1 group">
                        ...
                        >
                            <svg className="w-8 h-8" viewBox="0 0 24 24" title="Subtitles">
                                {isShowSubtitle ? (
